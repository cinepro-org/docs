...
<CardGroup cols={2}>
  ...
  <Card title="Type‑safe architecture" icon="braces">
  ...
  <Card title="Docker‑ready deployment" icon="docker">
    ...
    Ship CinePro Core with Docker or Docker Compose, including optional Redis, using the provided [`Dockerfile`](https://github.com/cinepro-org/core/blob/main/Dockerfile) and compose configuration.
