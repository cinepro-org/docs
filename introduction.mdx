---
title: "CinePro Core: OMSS streaming backend for movies and TV"
description: "Learn how CinePro Core, an OMSS-compliant TypeScript streaming backend, aggregates third-party providers into a single unified API for movies and TV."
mode: "wide"
---
