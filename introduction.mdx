---
title: "CinePro Core: OMSS-compliant streaming backend"
description: "CinePro Core is an OMSS-compliant TypeScript streaming backend that aggregates third-party movie and TV providers into a single, unified scraping API."
mode: "wide"
---
