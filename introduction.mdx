...
<CardGroup cols={2}>
  ...
  <Card title="MCP support for AI agents" icon="bot">

    CinePro Core can expose a [Model Context Protocol](https://modelcontextprotocol.io) server that lets AI agents query stream sources directly. Opt in by setting `MCP_ENABLED=true` in your environment.
