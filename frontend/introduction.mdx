---
title: "CinePro Frontend: React web UI and HLS player"
description: "Browse and watch movies and TV shows with CinePro Frontend, the React-based reference web UI and HLS video player built on top of CinePro Core."
mode: "wide"
---
