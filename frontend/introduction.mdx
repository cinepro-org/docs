---
title: "CinePro Frontend: React web UI for streaming"
description: "CinePro Frontend is a React-based web interface for browsing and watching movies and TV shows via HLS, built as a developer test client for CinePro Core."
mode: "wide"
---
