---
title: "Environment variables reference for CinePro Core"
description: "Complete reference for configuring CinePro Core via .env: required TMDB API key, optional caching, proxy, port, logging, and provider settings."
---
