---
title: "Streaming providers in CinePro Core"
description: "Learn how CinePro Core's modular provider system works: TypeScript classes built on @omss/framework that supply streaming sources for movies and TV shows."
---
