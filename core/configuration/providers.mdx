...
description: "Learn how CinePro Core's modular provider system works and how to build a TypeScript provider class on top of the @omss/framework BaseProvider interface."
---
