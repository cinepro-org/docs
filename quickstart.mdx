---
title: "Quickstart: install and run CinePro Core locally"
description: "Install and run the CinePro Core streaming backend in under 10 minutes using Docker or Node.js, with your TMDB API key and a basic env setup."
mode: "wide"
---
